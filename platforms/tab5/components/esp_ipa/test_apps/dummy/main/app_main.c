...
TEST_CASE("detect IPAs", "[IPA]")
{
    ...
    const char *ipa_names[]          = {"awb.gray", "agc.threshold"};
    const uint8_t ipa_nums           = sizeof(ipa_names) / sizeof(ipa_names[0]);
    esp_ipa_pipeline_handle_t handle = NULL;
    esp_ipa_stats_t stats            = {.flags     = IPA_STATS_FLAGS_AWB | IPA_STATS_FLAGS_AE,
                             .awb_stats = {{
                                 .counted = counted,
                                 .sum_b   = counted * 140,
                                 .sum_g   = counted * 200,
                             ...
                             .ae_stats  = {{50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50},
                                          {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}, {50}}};
    esp_ipa_sensor_t info            = {.width        = 1080,
                             .height       = 720,
                             .cur_exposure = 10e3,
                             .max_exposure = 30e3,
                             .min_exposure = 10e3,
