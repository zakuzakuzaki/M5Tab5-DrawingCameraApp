...
#define EXAMPLE_LCD_PANEL_35HZ_RGB_TIMING()                                                                           \
    {                                                                                                                 \
        .pclk_hz = 18 * 1000 * 1000, .h_res = EXAMPLE_LCD_H_RES, .v_res = EXAMPLE_LCD_V_RES, .hsync_pulse_width = 40, \
        .hsync_back_porch = 40, .hsync_front_porch = 48, .vsync_pulse_width = 23, .vsync_back_porch = 32,             \
        .vsync_front_porch = 13, .flags.pclk_active_neg = true,                                                       \
    }
