...
static const esp_cam_sensor_isp_info_t sc030iot_isp_info[] = {{.isp_v1_info = {
...
static esp_err_t sc030iot_write_reg_bits_a16v8(esp_sccb_io_handle_t sccb_handle, uint16_t reg, uint8_t offset,
...
static esp_err_t sc030iot_query_support_capability(esp_cam_sensor_device_t *dev,
...
static const esp_cam_sensor_ops_t sc030iot_ops = {.query_para_desc          = sc030iot_query_para_desc,
