...
static esp_err_t ov5647_set_reg_bits(esp_sccb_io_handle_t sccb_handle, uint16_t reg, uint8_t offset, uint8_t length,
                                     uint8_t value)
{
    esp_err_t ret    = ESP_OK;
    uint8_t reg_data = 0;
...
static const esp_cam_sensor_ops_t ov5647_ops = {.query_para_desc          = ov5647_query_para_desc,
