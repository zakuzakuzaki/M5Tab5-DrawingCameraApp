...
#define gc2145_1lane_enable                         \
    {GC2145_REG_RESET_RELATED, 0x03}, {0x01, 0x83}, \
    {                                               \
        0x10, 0x94                                  \
    }

#define gc2145_2lane_enable                         \
    {GC2145_REG_RESET_RELATED, 0x03}, {0x01, 0x87}, \
    {                                               \
        0x10, 0x95                                  \
    }
...
static const gc2145_reginfo_t gc2145_DVP_8bit_20Minput_640x480_yuv422_15fps_windowing[] = {
    ...
    {0x81, 0x24},  // 26//24 //BLK dither mode, ll_y_en ,skin_en, edge SA, new_skin_mode, autogray_en,ll_gamma_en,BFF
                   // test image
    ...
    {0x8a, 0x00},  // ISP_quiet_mode,close aaa pclk,BLK gate mode,exception,close first pipe clock,close dndd
                   // clock,close intp clock,DIV_gatedclk_en
