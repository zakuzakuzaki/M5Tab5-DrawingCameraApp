...
#define ov2640_settings_jpeg3                                                                                        \
    {BANK_SEL, BANK_DSP}, {RESET, RESET_JPEG | RESET_DVP}, {IMAGE_MODE, IMAGE_MODE_JPEG_EN | IMAGE_MODE_HREF_VSYNC}, \
        {0xD7, 0x03}, {0xE1, 0x77}, {0xE5, 0x1F}, {0xD9, 0x10}, {0xDF, 0x80}, {0x33, 0x80}, {0x3C, 0x10},            \
        {0xEB, 0x30}, {0xDD, 0x7F},                                                                                  \
    {                                                                                                                \
        RESET, 0x00                                                                                                  \
    }
...
#define ov2640_settings_yuv422                                                                             \
    {BANK_SEL, BANK_DSP}, {RESET, RESET_DVP}, {IMAGE_MODE, IMAGE_MODE_YUV422}, {0xD7, 0x01}, {0xE1, 0x67}, \
    {                                                                                                      \
        RESET, 0x00                                                                                        \
    }

#define ov2640_settings_rgb565                                                                             \
    {BANK_SEL, BANK_DSP}, {RESET, RESET_DVP}, {IMAGE_MODE, IMAGE_MODE_RGB565}, {0xD7, 0x03}, {0xE1, 0x77}, \
    {                                                                                                      \
        RESET, 0x00                                                                                        \
    }

#define ov2640_settings_to_cif                                                                                        \
    {BANK_SEL, BANK_SENSOR}, {COM7, COM7_RES_CIF}, {COM1, 0x0A}, /*Set the sensor output window*/                     \
        {REG32, REG32_CIF}, {HSTART, 0x11}, {HSTOP, 0x43}, {VSTART, 0x00}, {VSTOP, 0x25}, {BD50, 0xca}, {BD60, 0xa8}, \
        {0x5a, 0x23}, {0x6d, 0x00}, {0x3d, 0x38}, {0x39, 0x92}, {0x35, 0xda}, {0x22, 0x1a}, {0x37, 0xc3},             \
        {0x23, 0x00}, {ARCOM2, 0xc0}, {0x06, 0x88}, {0x07, 0xc0}, {COM4, 0x87}, {0x0e, 0x41}, {0x4c, 0x00},           \
        {BANK_SEL, BANK_DSP}, {RESET, RESET_DVP}, {HSIZE8, 0x32}, /*Set the sensor resolution (UXGA, SVGA, CIF)*/     \
        {VSIZE8, 0x25}, {SIZEL, 0x00}, {HSIZE, 0x64},             /*Set the image window size >= output size*/        \
        {VSIZE, 0x4a}, {XOFFL, 0x00}, {YOFFL, 0x00}, {VHYX, 0x00}, {TEST, 0x00}, {CTRL2, CTRL2_DCW_EN | 0x1D},        \
    {                                                                                                                 \
        CTRLI, CTRLI_LP_DP | 0x00                                                                                     \
    }

#define ov2640_settings_to_svga                                                                                       \
    {BANK_SEL, BANK_SENSOR}, {COM7, COM7_RES_SVGA}, {COM1, 0x0A}, {REG32, REG32_SVGA}, {HSTART, 0x11}, {HSTOP, 0x43}, \
        {VSTART, 0x00}, {VSTOP, 0x4b}, {0x37, 0xc0}, {BD50, 0xca}, {BD60, 0xa8}, {0x5a, 0x23}, {0x6d, 0x00},          \
        {0x3d, 0x38}, {0x39, 0x92}, {0x35, 0xda}, {0x22, 0x1a}, {0x37, 0xc3}, {0x23, 0x00}, {ARCOM2, 0xc0},           \
        {0x06, 0x88}, {0x07, 0xc0}, {COM4, 0x87}, {0x0e, 0x41}, {0x42, 0x03}, {0x4c, 0x00}, {BANK_SEL, BANK_DSP},     \
        {RESET, RESET_DVP}, {HSIZE8, 0x64}, {VSIZE8, 0x4B}, {SIZEL, 0x00}, {HSIZE, 0xC8}, {VSIZE, 0x96},              \
        {XOFFL, 0x00}, {YOFFL, 0x00}, {VHYX, 0x00}, {TEST, 0x00}, {CTRL2, CTRL2_DCW_EN | 0x1D},                       \
    {                                                                                                                 \
        CTRLI, CTRLI_LP_DP | 0x00                                                                                     \
    }

#define ov2640_settings_to_uxga                                                                                       \
    {BANK_SEL, BANK_SENSOR}, {COM7, COM7_RES_UXGA}, {COM1, 0x0F}, {REG32, REG32_UXGA}, {HSTART, 0x11}, {HSTOP, 0x75}, \
        {VSTART, 0x01}, {VSTOP, 0x97}, {0x3d, 0x34}, {BD50, 0xbb}, {BD60, 0x9c}, {0x5a, 0x57}, {0x6d, 0x80},          \
        {0x39, 0x82}, {0x23, 0x00}, {0x07, 0xc0}, {0x4c, 0x00}, {0x35, 0x88}, {0x22, 0x0a}, {0x37, 0x40},             \
        {ARCOM2, 0xa0}, {0x06, 0x02}, {COM4, 0xb7}, {0x0e, 0x01}, {0x42, 0x83}, {BANK_SEL, BANK_DSP},                 \
        {RESET, RESET_DVP}, {HSIZE8, 0xc8}, {VSIZE8, 0x96}, {SIZEL, 0x00},                                            \
        {HSIZE, 0x90}, /*Set the image window size >= output size*/                                                   \
        {VSIZE, 0x2c}, {XOFFL, 0x00}, {YOFFL, 0x00}, {VHYX, 0x88}, {TEST, 0x00}, {CTRL2, CTRL2_DCW_EN | 0x1d},        \
    {                                                                                                                 \
        CTRLI, 0x00                                                                                                   \
    }
...
static const ov2640_reginfo_t init_reglist_DVP_8bit_RAW8_1600x1200_XCLK_20M_15fps[] = {
    {BANK_SEL, BANK_DSP}, {0x2c, 0xff}, {0x2e, 0xdf}, {BANK_SEL, BANK_SENSOR},
    {0x3c, 0x32},

    {CLKRC, 0x00},        {0x09, 0x04}, {0x04, 0x00}, {0x13, 0xe5},
    {0x14, 0x48},         {0x2c, 0x0c}, {0x33, 0x78}, {0x3a, 0x33},
    {0x3b, 0xfB},
    ...
    {0x32, 0x36},         {0x03, 0x0f}, {0x37, 0x40},

    {0x4f, 0xca},         {0x50, 0xa8}, {0x5a, 0x23}, {0x6d, 0x00},
    {0x6d, 0x38},

    {BANK_SEL, BANK_DSP}, {0xe5, 0x7f}, {0xf9, 0xc0}, {0x41, 0x24},
    {0xe0, 0x14},         {0x76, 0xff}, {0x33, 0xa0}, {0x42, 0x20},
    {0x43, 0x18},         {0x4c, 0x00}, {0x87, 0x50}, {0x88, 0x3f},
    ...
    {0x5c, 0x05},         {0xd3, 0x03},  // Be careful when setting up auto
    {0x7f, 0x00},         {0xda, 0x04}, {0xe5, 0x1f}, {0xe1, 0x67},
    {0xe0, 0x00},         {0xdd, 0x7f}, {0x05, 0x00}, {REG_DELAY, 0x10},
};
