...
#define ELEMENT_SET_FREE(e) \
    {                       \
        (e)->free = true;   \
    }
#define ELEMENT_SET_ALLOCATED(e) \
    {                            \
        (e)->free = false;       \
    }
...
struct esp_video_buffer_info {
    ...
    uint32_t align_size; /*!< Buffer align size in byte, if buffer capability contains of MALLOC_CAP_CACHE_ALIGNED, this
 ...
 * @return None
 */
static inline void esp_video_buffer_element_set_valid_size(struct esp_video_buffer_element *element,
                                                           uint32_t valid_size)
{
 ...
 */
static inline uint32_t esp_video_buffer_get_element_offset(struct esp_video_buffer *buffer,
 ...
 */
static inline struct esp_video_buffer_element *esp_video_buffer_get_element_by_offset(struct esp_video_buffer *buffer,
                                                                                      uint32_t offset)
{
